...
var active = quoteList
const buttonReload = document.getElementById("button")
const span1 = document.getElementById("span1")
const span2 = document.getElementById("span2")
buttonReload.addEventListener('click', ()=>{
    var randomQuote = active[Math.floor(Math.random() * active.length)]
    span1.innerText= randomQuote.quoteText 
    span2.innerText= randomQuote.quoteAuthor
})